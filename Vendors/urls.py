...
from .views import Homepage, Signup, Login, Account, Image, logout, vendor_store, AddProduct, EditCategory, AddCategory
...
urlpatterns = [
    ...
    path("edit_products", AddProduct.as_view(), name='edit_product'),
