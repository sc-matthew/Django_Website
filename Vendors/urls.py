...
from .views import Homepage, Signup, Login, Account, Image, logout, vendor_store, ProductDetails, AddProduct, EditProduct, DeleteProduct, DeleteConfirm, EditCategory, AddCategory 
...
urlpatterns = [
    ...
    path("my_products/<int:product_id>",ProductDetails.as_view(), name="vendor_products"),
