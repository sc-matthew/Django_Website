...
from .views import Homepage, Signup, Login, Account, Image, logout, vendor_store, ProductDetails, AddProduct, EditProduct, DeleteProduct, DeleteConfirm, EditCategory, AddCategory, VendorDetail 
